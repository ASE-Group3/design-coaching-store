import { MainNav, UpperNavBar } from "../components";
  ...
  return(
    <div>
      ...
      <div className="flex flex-col border-solid border-2 rounded-lg shadow-xl">
        ...
        <p className="m-2 text-xs font-bold">Long Flat Dress Close Lineup Vintage</p>
      ...
      <div className="flex flex-col border-solid border-2 rounded-lg shadow-xl">
        ...
        <div className="flex justify-center">
        <p className="m-2 text-xs font-bold">Oaxacan Rainbow Top-Technicolor</p>
